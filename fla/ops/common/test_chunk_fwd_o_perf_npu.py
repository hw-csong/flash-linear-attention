...
"""
Performance test for `chunk_fwd_o` on Ascend NPU.

Run as a script:
    python fla/ops/common/test_chunk_fwd_o_perf_npu.py

NPU counterpart of `test_chunk_fwd_o_perf.py`. See that file for the covered
Triton kernel and shape rationale; this script differs only in:
...
from fla.ops.common.chunk_o import chunk_fwd_o  # noqa: E402
